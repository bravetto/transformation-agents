 ...
 */
const EtherealParticles = ({ className }: { className?: string }) => {
...
export function PersonCardSkeleton({
  ...
  return (
    ...
    >
      ...
      {/* Content skeleton */}
      <div className={cn(
        "relative h-full flex flex-col justify-end z-10",
      )}>
        <div className={cn(
...
export function ErrorWithRetry({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl font-bold text-white mb-3">Divine Connection Interrupted</h3>
...
// Export individual components and LoadingPage as default
