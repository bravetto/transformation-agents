    ...
    <div className={`relative ${className}`}>
      ...
      >
        ...
        <div className="relative z-10">
          <p className="text-sm text-hope-gold font-semibold mb-2">
            Latest Supporters:
          </p>
          <AnimatePresence mode="popLayout">
            {recentHearts.map((heart) => (
              ...
              >
                ...
                <span className="text-gentle-charcoal font-medium">
                  {heart.name} from {heart.location} joined the movement
                </span>
              </motion.div>
            ))}
          </AnimatePresence>
        ...
        >
          {hasAddedHeart
            ? "Your Heart is Beating with JAHmere ❤️"
            : "Add Your Heart"}
        </motion.button>
