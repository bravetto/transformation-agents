...
const books = [
  {
    ...
    jahmereNote: "Coach Dungy taught me that transformation starts with believing someone can change.",
    color: "bg-courage-blue"
  },
  {
    title: "The Mentor Leader",
    subtitle: "Secrets to Building People & Teams",
    quote: "Mentor leadership is all about shaping, nurturing, empowering, and growing. It's all about relationships.",
    jahmereNote: "Just like Coach mentored his players, I want to mentor youth who need someone to believe in them.",
    color: "bg-growth-green"
  },
  {
    title: "Quiet Strength",
    subtitle: "The Principles, Practices & Priorities",
    quote: "God's definition of success is really one of significance—the significant difference our lives can make in the lives of others.",
    jahmereNote: "My journey from darkness to light can be someone else's roadmap to transformation.",
    color: "bg-hope-gold"
  }
]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-soft-shadow max-w-2xl mx-auto">
            ...
            These books showed JAHmere that character matters more than circumstances.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {books.map((book, index) => (
            ...
            >
              ...
              `}>
                <div className={`h-64 ${book.color} p-6 flex flex-col justify-center`}>
                  <h3 className="text-2xl font-bold mb-2 text-white">{book.title}</h3>
                ...
                <div className="bg-white p-6">
                  ...
                  <div className="bg-moon-glow rounded-lg p-4">
                    <p className="text-xs font-semibold text-courage-blue mb-1">JAHmere's Note:</p>
                    <p className="text-sm text-gentle-charcoal">{book.jahmereNote}</p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-courage-blue text-white rounded-lg p-8 max-w-3xl mx-auto">
          <blockquote className="text-xl italic mb-4">
            ...
            in the long hours of preparation. The becoming is the doing."
          </blockquote>
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-lg text-gentle-charcoal mb-4">
            Your support helps JAHmere become a mentor leader for the next generation
          </p>
