...
export const coachDungy: PersonData = {
  ...
  heroImage:
    "https://images.unsplash.com/photo-1508672019048-805c876b67e2?w=1920&h=1080&fit=crop",
  localImage: true,

  testimony: {
    quote:
      "I won Super Bowls, but my greatest victories are the lives transformed through second chances. Pain is God's megaphone, and I've learned to listen.",
        ...
        achievements: [
          {
            ...
            description:
              "First African American coach to win Super Bowl, breaking barriers for future generations",
            year: "2007",
          },
          {
            id: "achievement-2",
            ...
            description:
              "Transformed Tampa Bay Buccaneers from worst to first, establishing championship culture",
            year: "2002",
          },
          {
            id: "achievement-3",
            ...
            description:
              "Mentored Michael Vick through redemption journey after incarceration",
            year: "2009",
          },
          {
            id: "achievement-4",
            ...
            description:
              'Authored "Quiet Strength" selling over 2 million copies and changing leadership paradigms',
            year: "2007",
          },
          {
            id: "achievement-5",
            ...
            description:
              "Proved you can win at the highest levels while maintaining faith and integrity",
            year: "Present",
          },
        ],
      },
...
Coach Tony Dungy`,
  ...
  metadata: {
    ...
    description:
      "Learn how Coach Tony Dungy's pain philosophy transforms lives through second chances, from Super Bowl championships to prison ministry.",
