...
export const michaelMataluni: PersonData = {
  ...
  heroImage: "/images/people/michael-mataluni.svg",
  localImage: true,
  ...
  testimony: {
    quote:
      "The digital landscape isn't just code and servers—it's the new frontier of human connection. Building bridges between technology and faith isn't just possible; it's essential for our collective future.",
  ...
  impact: {
    ...
    description:
      "Creating digital infrastructure for spiritual transformation and social impact",
    stats: [
      {
  ...
  sections: [
    {
      ...
      content: {
        ...
        description:
          "Building digital infrastructure for spiritual transformation at global scale",
        backgroundImage:
          "https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?w=1920&h=1080&fit=crop",
      },
    },
    {
      type: "testimony",
      content: {
        ...
        description:
          "The journey from tech entrepreneur to divine bridge builder",
        testimonies: [
          {
            id: "testimony-1",
            quote:
    ...
    },
    {
      ...
      content: {
        ...
        description:
          "Building systems that scale human connection and spiritual transformation",
        stats: [
          {
            id: "stat-1",
            value: "350+",
        ...
        achievements: [
          {
            ...
            description:
              "Designed scalable systems for Fortune 500 companies and startups alike",
            year: "2005-Present",
          },
          {
            id: "achievement-2",
            ...
            description:
              "Founded multiple developer communities and mentorship programs",
            year: "2010-Present",
          },
          {
            id: "achievement-3",
            ...
            description:
              "Pioneered frameworks for bringing spiritual principles into technical architecture",
            year: "2018-Present",
          },
          {
            id: "achievement-4",
            ...
            description:
              "Established the technical infrastructure for The Bridge Project's global scaling",
            year: "2023",
          },
          {
            id: "achievement-5",
            ...
            description:
              "Advised organizations on mindful integration of technology and human values",
            year: "2015-Present",
          },
        ],
      },
    },
    {
      ...
      content: {
        ...
        description:
          "Michael explores how technical systems can embody spiritual principles",
...
Michael Mataluni`,
  ...
  metadata: {
    ...
    description:
      "Meet Michael Mataluni, the technical visionary bringing decades of software architecture experience to build digital infrastructure for The Bridge Project.",
