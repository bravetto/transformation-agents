...
export const jayForte: PersonData = {
  ...
  testimony: {
    quote:
      "Most people play small because they don't know their capacity for greatness. I help them discover, develop, and deploy their unique gifts.",
  ...
  sections: [
    ...
    },
    {
      ...
      content: {
        title: "Architecting Human Greatness",
        description:
          "When you show people their zone, they transform their world",
        stats: [
          {
            id: "stat-1",
            value: "10,000+",
        ...
        achievements: [
          {
            ...
            description:
              "Created comprehensive talent assessment system that reveals individual purpose and potential",
            year: "2010",
          },
          {
            id: "achievement-2",
            ...
            description:
              'Pioneered "Greatness Zone" methodology now used in organizations worldwide',
            year: "2015",
          },
          {
            id: "achievement-3",
            ...
            description:
              "Transformed companies through deeper understanding of human potential",
            year: "2018",
          },
          {
            id: "achievement-4",
            ...
            description:
              "Perfect assessment match with JAHmere Webb proving the system works",
            year: "2023",
          },
          {
            id: "achievement-5",
            ...
            description:
              "Teaching the world to Discover, Develop, Deploy their unique talents",
            year: "Present",
          },
        ],
      },
    },
    {
      ...
      content: {
        ...
        message:
          "When you find someone whose greatness zone aligns with yours, you've found more than a match—you've found a mirror that shows what's possible.",
      },
    },
    {
      type: "custom",
      content: {
        component: "JayForteTestimony",
        title: "Letters to Judge Ferrero & Coach Dungy",
        description:
          "Using 40 years of human development expertise to advocate for JAHmere Webb",
      },
    },
    {
      type: "letter",
...
Jay Forte`,
  ...
  metadata: {
    ...
    description:
      "Jay Forte helps people discover their unique talents and purpose, finding their Greatness Zones where they can make their greatest contribution.",
