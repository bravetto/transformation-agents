...
export const marthaHenderson: PersonData = {
  ...
  testimony: {
    quote:
      "A mother's prayers can move mountains, and I've watched God move them for my son.",
  ...
  impact: {
    ...
    description:
      "Martha Henderson, JAHmere's mother, whose unwavering faith and prayers have been the foundation for her son's transformation journey. Her testimony speaks to the power of a mother's love and the impact of persistent prayer.",
    stats: [
  ...
  sections: [
    {
      ...
      content: {
        ...
        description:
          "A mother's prayers can move mountains, and I've watched God move them for my son. When JAHmere was struggling, I never stopped believing in God's perfect plan.",
        backgroundImage:
          "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=1920&h=1080&fit=crop",
        ...
        achievements: [
          {
            ...
            description:
              "Graduated with honors from UF as a married mother of two",
            year: "2000",
          },
          {
            id: "achievement-2",
            ...
            description:
              "Transformed from D student to honor roll after moving to NJ",
            year: "1990",
          },
          {
            id: "achievement-3",
...
Martha "Mama" Henderson`,
  ...
  metadata: {
    ...
    description:
      "Discover how Martha Henderson's unwavering faith and prayers became the foundation for her son JAHmere's transformation. A testimony of a mother's love and the power of persistent prayer.",
