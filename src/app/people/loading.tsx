              ...
              <div className="glass backdrop-blur-md rounded-xl p-6 space-y-6 sticky top-24">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="h-8 shimmer shimmer-lightworker rounded-full w-24"></div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="h-8 shimmer shimmer-messenger rounded-full w-20"></div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[...Array(6)].map((_, i) => (
                      <div key={i} className="h-8 shimmer shimmer-witness rounded-full w-28"></div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="h-8 shimmer shimmer-guardian rounded-full w-24"></div>
                    ))}
                  </div>
                </div>
